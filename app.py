...
def adc_cliente():
    ...
    (query_db("INSERT INTO Clientes (nome, morada, telefone) VALUES (?, ?, ?)"),)
...
def adc_hamburguer():
    ...
    query_db(
        "INSERT INTO Hamburguers (nome_hamburguer, ingredientes) VALUES (?, ?)",
...
def adc_pedido():
    ...
    nome_hamburguer = data["nome_hamburguer"]
    quantidade = data["tamanho"]
    valor_total = data["valor_total"]
    query_db(
        "INSERT INTO Hamburguers (id_cliente, nome_hamburguer, quantidade, tamanho, valor_total) VALUES (?, ?, ?, ?, ?)",
        [id_cliente, nome_hamburguer, quantidade, valor_total],
    )
